...
public class MeetUpPlace extends AppCompatActivity implements View.OnClickListener{
    ...
    private void getData(){
        ...
        DatabaseReference myRef = database.getReference("details/"+ new CompareTwoString(sender,receiver).compare()+"/places");
    ...
    private void  getNewAddress(double usrLng, double usrLat) throws IOException {
        ...
        adapter = new MeetUpPlaceAdapter(addresses,MeetUpPlace.this);
